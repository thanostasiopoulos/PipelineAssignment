...
## Run tests
poetry run pytest src/tests/test_api.py

## API URL
Endpoint 1: Health http://127.0.0.1:8000/health

Endpoint 2: Metrics http://127.0.0.1:8000/metrics

Endpoint 2: Metrics http://127.0.0.1:8000/metrics?service=checkout&from=2026-01-13T11%3A32%3A14Z&to=2026-01-23T11%3A32%3A14Z
...
The pipeline treats the dataset as streamed operational events and aims to keep what can still contribute to aggregate metrics.
...
- Normalized to UTC for the event_ts field. Kept the original timestamp just for reference
